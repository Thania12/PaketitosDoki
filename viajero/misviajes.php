                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <ul>
                                ...
                                <li><a class="nav-link" href="viajes.php"> Viaje Nuevo</a></li>
                                <li><a class="nav-link"
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr>
														...
														<form action="actualizaMisEnvios.php" method="POST">
                                                            ...
                                                            <button name = "entregado" class="border-0 font-weight-bold" type="submit" value="'.$reg["ID"].'"
                                                                style="background-color:green; color: white;">Entregado
															</button>
														</form>
                                                        </td>
													</tr>
                            ...
                            <div class="row sub-columns">
                                ...
                                <div class="col-lg-4 col-md-6 sub-one-left mid-footer-gd">
                                    <div class="sub-two-right">
                                        <h6> Menú </h6>
                                        <ul>
                                            <li><a href="viajes.php"><span class="fa fa-angle-right mr-2"></span>Viajes
                                                </a>
                                            </li>
